...
export class ScheduleItemDto {
  ...
  @ApiProperty({
    description: 'Whether this schedule rule is active',
    example: true,
  })
  isActivated: boolean;

  @ApiProperty({
    description: 'Start day of the week (0=Sunday, 1=Monday, ..., 6=Saturday)',
    example: 1,
  })
  dayOfWeekInit: number;

  @ApiProperty({
    description: 'End day of the week (0=Sunday, 1=Monday, ..., 6=Saturday)',
    example: 5,
  })
  dayOfWeekEnd: number;
...
export class ScheduleListResponseDto {
  @ApiProperty({
    description: 'List of operating schedules',
