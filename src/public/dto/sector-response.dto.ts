...
export class SectorListItemDto {
    ...
    @ApiProperty({
        description: 'Display priority (lower values shown first)',
        example: 1,
    })
    priority: number;
    ...
    @ApiProperty({
        description: 'Secondary or cross street name',
        example: 'Calle Guayaquil',
    })
    sideStreet: string;

    @ApiProperty({
        description: 'Maximum parking duration (HH:mm:ss)',
        example: '01:30:00',
    })
    timeLimit: string;

    @ApiProperty({
        description: 'Grace period before fine (HH:mm:ss)',
        example: '00:15:00',
    })
    timeGrace: string;

    @ApiProperty({
        description: 'Duration per billing fraction (HH:mm:ss)',
        example: '00:15:00',
    })
...
export class SectorDetailItemDto extends SectorListItemDto {
    @ApiProperty({
        ...
        example: 'Downtown sector near plaza',
    })
    description: string;
    ...
    @ApiProperty({
        description: 'Operating schedules for this sector',
...
export class SectorListResponseDto {
    ...
    @ApiProperty({
        description: 'Total number of matching sectors',
        example: 25,
    })
    total: number;
}
...
export class SectorDetailResponseDto {
    @ApiPropertyOptional({
        description: 'Sector detail or null if not found',
        type: SectorDetailItemDto,
    })
