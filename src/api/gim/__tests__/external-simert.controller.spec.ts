...
describe('ExternalSimertController', () => {
  ...
  // asserted with the very matcher Nest applies at bootstrap.
  it('is excluded from the global prefix, and only itself', () => {
    const excluded = mapToExcludeRoute([
      { path: PAID_OBLIGATIONS_ROUTE, method: RequestMethod.GET },
    ]);
