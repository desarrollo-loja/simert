...
export class IncidentController {
    ...
    @ApiOperation({
        summary:
            'Check outstanding fines by plate or identity card (external GIM)',
    })
    @ApiStandardResponse({
    ...
    @AuthWithKeycloak()
    @Get(
        'find-all-sanctions-by-fraction/:userId/:idDevice/:fractionId/:version',
    )
    ...
    getTransactionsByReference(
        ...
        return this.incidentService.getTransactionsByReference(
            userId,
            reference,
        );
    }
