...
export class FractionStatus {
    ...
    @PrimaryGeneratedColumn('increment', { primaryKeyConstraintName: 'pkFractionStatusId' })
    id: number;
    ...
    @JoinColumn({ name: 'fractionId', foreignKeyConstraintName: 'fkFractionStatusFraction' })
    fraction: Fraction;
    ...
    @JoinColumn({ name: 'statusId', foreignKeyConstraintName: 'fkFractionStatusStatus' })
    status: Status;
