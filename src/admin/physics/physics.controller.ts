...
export class PhysicsController {
    ...
    @ApiOperation({
        summary:
            'List physical card records with optional filters (admin only)',
    })
    ...
    @ApiOperation({
        summary:
            'Count total physical card records matching filters (admin only)',
    })
    @AuthWithKeycloak(TypeRol.ADMIN)
    ...
    @ApiOperation({
        summary:
            'Count unique physical card users matching filters (admin only)',
    })
    @AuthWithKeycloak(TypeRol.ADMIN)
